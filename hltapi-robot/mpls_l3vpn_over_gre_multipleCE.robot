#########################################################################################################################
#
# File Name:           mpls_l3vpn_over_gre_multipleCE.robot               
...
#             12.Configure GRE tunnel on port2
#             13.Start LDP router
#             14.Configure MPLS L3VPN PE on port2
#             15.Create MPLS L3VPN CE on port1 
#             16.Create MPLS L3VPN CE on port2
#             17.Create MPLS L3VPN traffic
#             18.Start catpure and start traffic
#             19.Stop traffic and stop catpure
#             20.Get traffic statistics
...
# 
# Run sample:
#            c:\>robot mpls_l3vpn_over_gre_multipleCE.robot
#
...
*** Test Cases ***
mpls l3vpn over gre multipleCE test

##############################################################
#config the parameters for the logging
##############################################################

    ${test_sta} =  test config  log=1   logfile=mpls_l3vpn_over_gre_multipleCE_logfile   vendorlogfile=mpls_l3vpn_over_gre_multipleCE_stcExport   vendorlog=1   hltlog=1   hltlogfile=mpls_l3vpn_over_gre_multipleCE_hltExport   hlt2stcmappingfile=mpls_l3vpn_over_gre_multipleCE_hlt2StcMapping   hlt2stcmapping=1   log_level=7
...
##############################################################
# Step12.Configure GRE tunnel on port2
##############################################################

    Log To Console  Create GRE Tunnel on PE router

    ${gre_ret} =  emulation gre config  gre_tnl_type=4   gre_tnl_addr=2.2.2.4   gre_dst_addr_step=0.0.0.1   
    ...  gre_tnl_addr_count=1   gre_src_mode=increment   gre_src_addr=13.32.0.11    gre_src_addr_step=0.0.0.1
    ...  gre_src_addr_count=1   gre_dst_mode=increment   gre_dst_addr=13.32.0.1   gre_dst_addr_step=0.0.0.1
...
##############################################################
# Step14.Configure MPLS L3VPN PE on port2
##############################################################
    ...
    ...  igp_session_handle=${ospfRouterPE}   bgp_session_handle=${bgpRouterPE}   tunnel_handle=${greTunnel}   pe_count=1
...
##############################################################
# Step15.Create MPLS L3VPN CE on port1 
##############################################################
...
##############################################################
# Step16.Create MPLS L3VPN CE on port2
##############################################################
...
##############################################################
# Step17.Create MPLS L3VPN traffic
##############################################################
...
##############################################################
# Step19.Stop traffic and stop catpure
############################################################## 
...
##############################################################
# Step20.Get traffic statistics
##############################################################

    Log To Console  \nGet traffic statistics of port2
