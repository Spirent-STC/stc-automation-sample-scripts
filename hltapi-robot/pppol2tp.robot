...
##############################################################
    ...
    ${device_ret1} =  l2tp config  l2_encap=ethernet_ii   l2tp_dst_count=1   l2tp_src_addr=192.85.1.3   l2tp_src_step=0.0.0.0   l2tp_dst_addr=192.85.1.4   l2tp_dst_step=0.0.0.1   ppp_server_ip=192.85.1.4   ppp_server_step=0.0.0.1   ppp_client_ip=192.0.1.0   ppp_client_step=0.0.0.1   port_handle=${port1}   max_outstanding=100   disconnect_rate=1000   mode=lns   attempt_rate=100   max_terminate_req=10   username=viavi   max_ipcp_req=10   echo_req_interval=10   password=viavi   config_req_timeout=3   terminate_req_timeout=3   max_echo_acks=0   auth_mode=none   echo_req=FALSE   enable_magic=TRUE   l2tp_mac_addr=00:10:94:00:00:02   l2tp_mac_step=00:00:00:00:00:01   hello_interval=60   hello_req=FALSE   force_lcp_renegotiation=FALSE   tunnel_id_start=1   num_tunnels=1   tun_auth=TRUE   session_id_start=1   redial=FALSE   avp_framing_type=sync   redial_max=1   redial_timeout=1   sessions_per_tunnel=1   avp_hide_list=0   avp_tx_connect_speed=56000   udp_src_port=1701   lcp_proxy_mode=none   secret=viavi   hostname=server.viavisolutions.com   rws=4
