#########################################################################################################################
#
# File Name:           HLTAPI_RFC3918_mixed_tput.py                 
# Description:         This script demonstrates the use of VIAVI HLTAPI to setup RFC3918_mixed_throughput in B2B mode.
#                      
# Test Steps:          
...
# 
# Run sample:
#            c:>python HLTAPI_RFC3918_mixed_tput.py 10.61.44.2 3/1 3/3
#
...
test_sta = sth.test_config (
    log                                              = '1',
    logfile                                          = 'HLTAPI_RFC3918__mixed_tput_logfile',
    vendorlogfile                                    = 'HLTAPI_RFC3918__mixed_tput_stcExport',
    vendorlog                                        = '1',
    hltlog                                           = '1',
    hltlogfile                                       = 'HLTAPI_RFC3918__mixed_tput_hltExport',
    hlt2stcmappingfile                               = 'HLTAPI_RFC3918__mixed_tput_hlt2StcMapping',
    hlt2stcmapping                                   = '1',
    log_level                                        = '7')
...
##############################################################
print "\n+++++ Start to create test -- mixed class throughput test : "
