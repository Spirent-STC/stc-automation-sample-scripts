...
# 
# Run sample:
#            c:>python HLTAPI_MPLS_L3VPN_Over_GRE_Multiple_CE.py 10.61.44.2 3/1 3/3
#
...
test_sta = sth.test_config (
    log                                              = '1',
    logfile                                          = 'HLTAPI_MPLS_L3VPN_Over_GRE_Multiple_CE_logfile',
    vendorlogfile                                    = 'HLTAPI_MPLS_L3VPN_Over_GRE_Multiple_CE_stcExport',
    vendorlog                                        = '1',
    hltlog                                           = '1',
    hltlogfile                                       = 'HLTAPI_MPLS_L3VPN_Over_GRE_Multiple_CE_hltExport',
    hlt2stcmappingfile                               = 'HHLTAPI_MPLS_L3VPN_Over_GRE_Multiple_CE_hlt2StcMapping',
    hlt2stcmapping                                   = '1',
    log_level                                        = '7')
...
sth.invoke ('stc::perform saveasxml -filename mpls_l3vpn_over_gre_multipleCE.xml')
