...
# Topology
#                   STC Port1                           DUT                        
#                [IPv6 Client/Host]------------------[IPv6 ND]
#                                              
# DUT configuration [Cisco 7200]:
#
#  ipv6 address 2001:1213::/64 eui-64
#  ipv6 enable
...
# Run sample:
#            c:>tclsh HLTAPI_ipv6AutoConfig_basic.tcl 10.61.44.2 3/1
...
if {$enableHltLog} {
::sth::test_config  -logfile ipv6AutoConfig_basic_hltLogfile \
                    -log 1 \
                    -vendorlogfile ipv6AutoConfig_basic_stcExport\
                    -vendorlog 1\
                    -hltlog 1\
                    -hltlogfile ipv6AutoConfig_basic_hltExport \
                    -hlt2stcmappingfile ipv6AutoConfig_basic_hlt2StcMapping \
                    -hlt2stcmapping 1 \
                    -log_level 7
...
puts "Saved XML....\n"
stc::perform SaveasXml -config system1 -filename    "HLTAPI_ipv6AutoConfig_basic_b4.xml"
...
stc::perform SaveasXml -config system1 -filename    "HLTAPI_ipv6AutoConfig_basic.xml"
puts "Saved XML....\n"
