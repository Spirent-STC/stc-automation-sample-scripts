...
# Run sample:
#            c:>tclsh HLTAPI_PPPoE_DHCPV6PD_SERVER_CLIENT_B2B.tcl 10.61.44.2 3/1 3/3
#            c:>tclsh HLTAPI_PPoE_DHCPV6PD_SERVER_CLIENT_B2B.tcl "10.61.44.2 10.61.44.7" 3/1 3/3
...
if {!$status} {
    ...
    keylget returnedString handle deviceHdlServer
}
########################################
...
if {!$status} {
    ...
    keylget returnedString handle deviceHdlClient
}
########################################
...
stc::perform SaveAsXmlCommand -filename  "./dhcpv6pd_over_pppox.xml"
