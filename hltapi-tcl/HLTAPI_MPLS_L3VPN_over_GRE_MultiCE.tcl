####################################################################################################
# 			         																									      						    
# Title : HLTAPI_MPLS_L3VPN_over_GRE_MultiCE
#
# Test Case : HLTAPI_MPLS_L3VPN_over_GRE_MultiCE
#
...
# Step 7. Config MPLS L3VPN PE(set the "-tunnel_handle" to be gre tunnel) use the command "sth::emulation_mpls_l3vpn_pe_config" with the BGP/LDP router handles.
...
#
# Revison History : -Even(WuHang) 2009/09/03, PV China Team
#
...
# Run sample:
#            c:>tclsh HLTAPI_MPLS_L3VPN_over_GRE_MultiCE.tcl 10.61.44.2 3/1 3/3
#            c:>tclsh HLTAPI_MPLS_L3VPN_over_GRE_MultiCE.tcl "10.61.44.2 10.61.44.7" 3/1 3/3
